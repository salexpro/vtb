...
pageWidget(['index', 'item', 'supplier', 'auction', 'auction-new', 'auction-organizer', 'auction-participant', 'auction-verifier',  'documents', 'documents-new', 'order', 'register', 'register-2', 'register-3', 'reports', 'wallet', 'main']);